...
### Added
- Language detection (`PR_LANG`/system `LANG`) to select matching PR template (English/中文)

### Fixed
- Replace Chinese overview placeholder when using zh template to inject PR title
